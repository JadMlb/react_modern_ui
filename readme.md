...
### v2.0.0 is in beta 14
The final planned beta is finally out.
Check the [change log](changelog.md#v200-beta14) to see what will change in the upcoming major version.
